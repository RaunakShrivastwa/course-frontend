                    ...
                    <div class="card" style={{ maxHeight: '540px', border: '0' }}>
                        <div class="row g-0">
                            <div className="col-md-2 d-flex justify-content-center justify-content-md-start" style={{ background: '#2d3668', border: '0' }}>
                                <img src="https://cdn-icons-png.flaticon.com/256/4825/4825038.png" className="p-3 img-fluid rounded-start" alt="..." />
                            </div>
                            <div class="col-md-10">
                                <div class="card-body" style={{ background: '#2d3668' }}>
                                    <p class="card-title text-primary">MileStone 1 &#8594; Introduction to Node Js</p>
