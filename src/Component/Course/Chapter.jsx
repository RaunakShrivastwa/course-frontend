...
function Chapter() {
    ...
    return (
        <div className='cp' style={containerStyle}>
            <div className='p-1 table-div'>
                <Link title='Click To Start Learning' className='chapter-title' to='/chapter/Dashboard/120'>
                    <table className="table chapter-body">
                        <tbody>
                            <tr className='heart' style={{ borderLeft: 0, borderRight: 0, borderBottom: 0 }}>
                                ...
                                <td className='bo'></td>
                                <td className='bo p-4'>
                                    <span className=""><strong className=''>IntroDuction With Node</strong></span>
                                </td>
